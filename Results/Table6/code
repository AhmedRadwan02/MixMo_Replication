...
def parse_args():
    parser = argparse.ArgumentParser(description='Replicate Table 6 from MixMo paper')
    
    # Fixed parameters for Table 6 replication
    parser.add_argument('--dataset', type=str, default='cifar100', 
                        help='Dataset to use')
    parser.add_argument('--approach', type=str, default='cut_mixmo_cutmix',
                        help='Approach to use (cut_mixmo_cutmix for Table 6)')
    parser.add_argument('--width', type=int, default=10,
                        help='Width factor for WRN-28-width')
    parser.add_argument('--batch_size', type=int, default=64,
                        help='Batch size')
    parser.add_argument('--batch_repetitions', type=int, default=4,
                        help='Batch repetition factor (b parameter)')
    ...
    parser.add_argument('--num_ensemble', type=int, default=1,
                        choices=[1, 2, 3], help='Number of models to ensemble (N)')
    parser.add_argument('--data_root', type=str, default='/home/pariamdz/projects/def-hinat/pariamdz/MixMo/datasets',
                        help='Path to data directory')
    parser.add_argument('--save_dir', type=str, default='/home/pariamdz/projects/def-hinat/pariamdz/MixMo/results/table6',
                        help='Directory to save results')
    parser.add_argument('--run_number', type=int, default=1,
                        help='Run 1, 2, or 3 for averaging')
...
def main():
    ...
    # Configure data loaders for cut_mixmo_cutmix approach
    batch_repetitions = args.batch_repetitions
    print(f"Using batch repetition: b = {batch_repetitions}")
    
    # First get the dataset without repetitions
    ...
    # For Table 6, we'll use an ensemble of N models
    N = args.num_ensemble
    ensemble_models = []
    ...
    # Save ensemble results for Table 6
    ensemble_results = {
        'ensemble_size': N,
        'width': args.width,
